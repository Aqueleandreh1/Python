        ...
        if option == "1":
            ...
            while True:
                ...
                if option == "1":
                    ...
                    save_json('data.json', get_data())
                    print(
                        f"Matrícula do estudante {enrollment['student_CPF']} na disciplina {enrollment['discipline_code']} cadastrada com sucesso!")
                elif option == "2":
                    print("Listar Matrículas")
                    print("Lista de Matrículas:")
                    for enrollment in enrollments:
                        print(
                            f"CPF do Estudante: {enrollment['student_CPF']} - Código da Disciplina: {enrollment['discipline_code']}")
                elif option == "3":
                    ...
                    enrollments = [e for e in enrollments if
                                   e["student_CPF"] != student_CPF or e["discipline_code"] != discipline_code]
                    save_json('data.json', get_data())
                elif option == "4":
                    ...
                    for enrollment in enrollments:
                        if enrollment["student_code"] == student_code and enrollment[
                            ...
                            save_json('data.json', get_data())
                            print(
                                f"Matrícula do estudante {enrollment['student_cod1e']} na disciplina {enrollment['discipline_code']} editada com sucesso!")
                            break
                    else:
